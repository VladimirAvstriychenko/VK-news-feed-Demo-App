...
//        static func authService() -> AuthentificationService{
//            return self.authService
//        }
    
//    static func shared() -> UISceneDelegate{
//        return UIApplication.shared.connectedScenes as! SceneDelegate
//    }
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let sb = UIStoryboard(name: "AuthViewController", bundle: nil)
//        let authVC = sb.instantiateInitialViewController() as? AuthViewController
